...
def test_advanced_grid_integration():
    ...
    print(f"✅ Grid System initialized: {grid_system.width}x{grid_system.height}")
    ...
    print(f"✅ Created {len(test_tiles)} test tiles with multi-layer data")
    ...
    print(f"✅ Created and placed {len(created_entities)} entities on grid")
    ...
    print(f"✅ Spatial queries completed:")
    ...
    print(f"✅ Event system integration verified:")
    ...
    print(f"     - Events processed: {event_stats['total_events_processed']}")
    print(f"     - Average processing time: {event_stats['average_processing_time_ms']:.2f} ms")
    ...
    print(f"✅ Grid expansion completed:")
...
if __name__ == "__main__":
    try:
        ...
        if success:
            print("\n✅ All tests passed! Advanced Grid System integration is working correctly.")
        else:
